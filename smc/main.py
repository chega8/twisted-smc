...
def parse_args():
    ...
    # parser.add_argument("--model_name", type=str, default="Qwen/Qwen2.5-7B", help="Name of the base model")
    parser.add_argument("--num_examples", type=int, default=100, help="Number of examples to use")
    parser.add_argument("--num_epochs", type=int, default=10, help="Number of training epochs")
    parser.add_argument("--batch_size", type=int, default=1, help="Batch size for training")
    parser.add_argument("--learning_rate", type=float, default=1e-1, help="Learning rate for optimizer")
    parser.add_argument("--output_dir", type=str, default="output", help="Directory to save outputs")
    parser.add_argument("--seed", type=int, default=42, help="Random seed")
    parser.add_argument("--split", type=str, default="train", help="Dataset split to use")
    parser.add_argument("--output_length", type=int, default=100, help="Length of output sequences")
    parser.add_argument("--num_twist_samples", type=int, default=8, help="Number of twist samples")
...
def main():
    ...
    # Setup logging
    # logger = setup_logging(args.output_dir, True)
    logger = setup_logging(args.output_dir, False)
    ...
    train_twist_for_math_problems(
        ...
        num_particles=args.num_twist_samples,
